          ...
          <div className="mex_w">
            <table class="table-fixed">
              <thead className="border-t-[#00000033] border-b-[#9626cb] border-b-[5px] border-t-[1px] justify-between h-[52px] ">
                <tr className="">
                  <th className="text-start font_f">Membership Id</th>
                  <th className="text-start font_f ">Membership Date</th>
                  <th className="text-start font_f">Membership Tier</th>
                  <th className="text-start font_f">Rewards Date</th>
                  <th className="text-start font_f">Percentage</th>
                  <th className="text-start font_f">Admin Fee</th>
                  <th className="text-start font_f">Released</th>
                </tr>
              </thead>
