  ...
  return (
    <div>
      <div className="py-6 bg-white drop-shadow-md rounded-lg">
        ...
        <h2 className="font-size-16 font-f  text-sm text-sm font-color text-center font-weight-600  m-0 ">
          AU8
        </h2>
        <div className="mx-5">
              ...
              <div className="px-gutter border-t py-2 ">
                {directbonus.map((item) => {
                  return (
                    ...
                    >
                      <p className="m-0 body-1 font-size-16 font-f  text-sm font-color text-center font-weight-600">
                        {item.text}
                      </p>
                      <p className="m-0 font-size-16 font-f  text-sm font-color text-right font-bold font-weight-800 ">
                        {item.value}
                      </p>
                    </div>
                  );
                ...
                {directbonus.map((item) => {
                  return (
                    <div className="flex last_border   items-center justify-between py-[18px] px-5 border-b-[1px] border-[#e5e7eb]">
                      ...
                      <p className="m-0 font-size-16 font-f  text-sm font-color text-center font-weight-600">
                        {item.text}
                      </p>
                    </div>
                  );
