...
function Internaltrans(){
      ...
      let table_data = [
        {
            ...
            status: "Success",
            mode: "Deposit",
            message:"Swap from Cash Wallet to Gift Wallet"
  ...
  <div className="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
    <div className="table-responsive"  >
      <table className="table table-flush "style={{    width: 'max-content'}}
       >
        ...
        <tbody>
        {
          ...
          <tr>
                    ...
                    <td className=" td text-center  text-[16px]">{table.date}</td>
                    <td className=" td text-center  text-[16px]">{table.amount}</td>
                    <td className=" td text-center  text-[16px] text-red-500">{table.fee}</td>
                    <td className=" td text-center text-[16px]">{table.recieved_amount}</td>
                    <td className=" td text-center text-[16px]">{table.status}</td>
                    <td className=" td text-center text-[16px]">{table.mode}</td>
                    <td className=" td text-center text-[16px]">{table.message}</td>
