       ...
       >
        ...
        <tbody>
        {
          ...
          <tr>
                    ...
                    <td className=" td text-center  text-[16px]">{table.payment_id}</td>
                    <td className=" td text-center  text-[16px]">{table.date}</td>
                    <td className=" td text-center  text-[16px]">{table.amount}</td>
                    <td className=" td text-center text-[16px] text-orange-400">{table.status}</td>
                    <td className=" td text-center text-[16px]">{table.mode}</td>
                    <td className=" td text-center text-[16px]">{table.message}</td>
                    {/* <td className=" td text-center text-[16px]">{table.current_right_tv}</td>
                    <td className=" td text-center text-[16px]">{table.description}</td>
                    <td className=" td text-center text-[16px]">{table.date}</td> */}
