...
const RankCards = () => {
  return (
    <div>
      <div className=" mb-2 card1  h1-card1 mt-20">
        <div className=" flex relative">
          <div className="pt-4 pl-4 text-primary-contrast flex-auto">
            <h2
              // style="line-height: 20px;"

              className="font-size-14 m-0 w-5 font-f font-weight-600 font_f text-white text-sm font-semibold"
            >
              CURRENT RANK
            </h2>
          </div>
          ...
          <div className=" pr-4  flex-none self-center hidden sm:block -mt-14">
            <img
              src={crown}
              className="w-[155px] h-[175px]"
              // style=" width:155px;height: 175px;"
            />
          </div>
        </div>
        ...
        <div className="flex items-center justify-between w-full mt-2">
          <div className=" text-left text-primary-contrast  mt-0 pl-4 pb-2  ">
            ...
            <span className="hover_hidden font-size-10 font_f font-weight-600 font-semibold text-white text-xs">
              Sept, 22. 2022
            </span>
          </div>
          <button
            ...
            type="button"
          >
            {/* <img className="icon_img_ht" src="assets/svg/More-Button.svg" /> */}
